...
import { ACTION_REPO_URL, APP_DESCRIPTION, APP_NAME, APP_URL, REPO_URL } from "@/lib/version";
...
- [\`GET /api/score?host=&repo=owner/name\`](${APP_URL}/api/score?host=github&repo=vercel/next.js): Look up an indexed repo by host + owner/name (powers the PR-diff Action and the agent skill)
