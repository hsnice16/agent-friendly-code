...
- **Freshness**: scheduled rescoring (v0.6.0) handles already-indexed repos via a 6-hourly GitHub Actions cron. The crawler fills in repos we haven't seen yet and re-checks long-dormant ones.
