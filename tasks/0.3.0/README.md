...
- [04-alternatives-v1.md](./04-alternatives-v1.md) — v1 SQL heuristic for "alternative repos" on the repo detail page. Upgraded to embedding-similarity in 0.6.0. **Done.**
