...
- [04-alternatives-v1.md](./04-alternatives-v1.md) — v1 SQL heuristic for "alternative repos" on the repo detail page. **Done.** (A v2 embedding upgrade was considered for 0.6.0 and [deferred to the backlog](../0.6.0/02-alternatives-v2-embeddings.md).)
- [05-package-registry-overlay.md](./05-package-registry-overlay.md) — npm / PyPI / Cargo lookup: `/package/:registry/:name` resolves to source repo and surfaces its score, with a pre-filled GitHub issue for anything unscored. Per-registry leaderboards + browser userscript stay in 0.7.0. **Done.**
